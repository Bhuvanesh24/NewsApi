// Navbar component - represents the navigation bar with news categories
  ...
  return (
    ...
    <nav className="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme='dark'>
      <div className="container-fluid">
        {/* Navbar brand */}
        <a className="navbar-brand" href="#"><span className="badge bg-light text-dark fs-6">NewsApi</span></a>
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav">
            {/* Individual navigation items for news categories */}
            {/* Set category function is called whenever a category is clicked */}
